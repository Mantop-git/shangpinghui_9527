      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="active" v-for="(item3,index) in floorList.navList" :key="index">
              <a href="#tab1" data-toggle="tab">{{item3.text}}</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="(item1, index) in floorList.keywords" :key="index">{{ item1 }}</li>
              </ul>
...
<script>
  ...
  export default {
    ...
    mounted() {
      var mySwiper2 = new Swiper(this.$refs.cur, {
